...
```{r assign_C01Ga_metrique, echo=FALSE, results='asis'}
if (exists("assignment2"))
  assignment2("C01Ga_metrique", part = NULL,
    url = "https://github.com/BioDataScience-Course/C01Ga_metrique",
    course.ids = c(
      'S-BIOG-025'         = !"C01Ga_{YY}M_metrique"),
    course.urls = c(
      'S-BIOG-025'         = "https://classroom.github.com/a/..."),
    course.starts = c(
      'S-BIOG-025'         = !"{W[5]+1} 8:00:00"),
    course.ends = c(
