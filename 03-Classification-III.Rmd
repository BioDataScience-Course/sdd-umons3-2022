...
if (exists("assignment"))
  assignment("C03Ia_cardiovascular", part = "I",
    ...
    course.urls = c(
      'S-BIOG-025'         = "https://classroom.github.com/a/XEjOaVvQ"),
    course.starts = c(
...
On se rapproche des scores de la foret aléatoire ici avec un *F* micro de 0.74 et un *F* macro de 0.736. Le noyau sigmoïde est ici désastreux, mais le noyau polynomial de degré 2 et avec un `coef0 = 1` donne ceci :
...
if (exists("challenge2"))
  challenge2("C03Ca_ml_wine", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-025' = "https://classroom.github.com/a/cHZ5HYlR",
      'sdd3late'   = "https://classroom.github.com/a/cHZ5HYlR"),
    course.starts = c(
